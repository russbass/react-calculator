...
const config = {
    ...
    module: { // Define loaders here
        rules: [ // array of rules to handle different file types
            ...
            {   // test for files ending with .css(uses regex)
                test: /\.css$/,
                // Use these loaders of .css files. 'css-loader gets run first and
                // is used to handle the imports of our css files inside our .jsx files.
